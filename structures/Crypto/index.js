...
const { chunkSizeSafe } = require('../utils.js');
const secureRandom = require('secure-random');
const { AES, CTR, MAC, prepareKey, prepareKeyV2 } = require('./aes.js');
...
module.exports = {
	constantTimeCompare,
	unmergeKeyMac, mergeKeyMac,
	megaEncrypt, megaDecrypt, megaVerify,
	e64, d64,
	AES, CTR, MAC, prepareKey, prepareKeyV2, formatKey,
	getCipher
